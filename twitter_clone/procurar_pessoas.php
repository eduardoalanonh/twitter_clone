...
////qts seguidores
//
//$sql = "SELECT COUNT(*) AS qtde_seguidores FROM usuario_seguidores where seguindo__id_usuario = $id_usuario";
//
//$resultado_id = mysqli_query($link, $sql);
//
//$qtde_seguidores = 0;
                ...
                <div class="panel-body">
                    <form id="form_procurar_pessoas">
                        <div class="input-group">
                            <input type="text" id="nome_pessoa" name="nome_pessoa" class="form-control" placeholder="Quem vc esta procurando?" maxlength="140">
